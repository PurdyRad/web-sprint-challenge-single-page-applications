...
useRouteMatch is a hook that is used to grab the url of the route you're currently in.
1. How would you explain form validation to someone who has never programmed before?
Form validation is a way of making sure that the values corresponding to inputs match up to what is to be expected.
1. In 1-2 sentences, define end to end testing.
End to end testing is a way of testing out the entire application as a whole, including all units/functions/components inside of it.
